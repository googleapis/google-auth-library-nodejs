...
var loginticket_1 = require("../lib/auth/loginticket");
describe('LoginTicket', function () {
    ...
    it('should return attributes from getAttributes', function () {
        var ticket = new loginticket_1.LoginTicket('myenvelope', 'mypayload');
        assert.deepEqual(ticket.getAttributes(), { envelope: 'myenvelope', payload: 'mypayload' });
    });
});
