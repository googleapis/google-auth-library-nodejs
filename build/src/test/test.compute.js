        ...
        it('should return a helpful message on request response.statusCode 403', function (done) {
            ...
            compute.request({}, function (err, result, response) {
                ...
                assert.equal('A Forbidden error was returned while attempting to retrieve an access ' +
                    ...
                    'Compute Engine instance does not have the correct permission scopes specified.', err.message);
                done();
            });
        });
        ...
        it('should return a helpful message on token refresh response.statusCode 403', function (done) {
            ...
            compute.request({}, function (err, result, response) {
                ...
                assert.equal('A Forbidden error was returned while attempting to retrieve an access ' +
                    ...
                    'Could not refresh access token.', err.message);
                nock.cleanAll();
                done();
            });
        });
