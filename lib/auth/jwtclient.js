...
var JWTHeader = require('./jwtheader.js');
 ...
 * @param {function} cb_with_access_token
 */
JWT.prototype.refreshAccessToken = function(opt_uri, cb_with_access_token) {
  if (this.createScopedRequired() && opt_uri) {
    // no scopes have been set, but a uri has been provided.  Use JwtHeader credentials.
    var jwth = new JWTHeader(this.email, this.key);
    jwth.refreshAccessToken(opt_uri, cb_with_access_token);
  } else {
    JWT.super_.prototype.refreshAccessToken.call(
        this, opt_uri, cb_with_access_token);
  }
};
